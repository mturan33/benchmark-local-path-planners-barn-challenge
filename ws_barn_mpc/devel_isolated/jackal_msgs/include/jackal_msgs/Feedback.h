...
bool operator==(const ::jackal_msgs::Feedback_<ContainerAllocator1> & lhs, const ::jackal_msgs::Feedback_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.drivers == rhs.drivers &&
    lhs.pcb_temperature == rhs.pcb_temperature &&
    lhs.mcu_temperature == rhs.mcu_temperature &&
    lhs.commanded_mode == rhs.commanded_mode &&
