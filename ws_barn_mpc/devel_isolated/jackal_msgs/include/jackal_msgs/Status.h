...
bool operator==(const ::jackal_msgs::Status_<ContainerAllocator1> & lhs, const ::jackal_msgs::Status_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.driver_external_stop_present == rhs.driver_external_stop_present &&
    lhs.driver_external_stop_stopped == rhs.driver_external_stop_stopped &&
    lhs.measured_battery == rhs.measured_battery &&
    lhs.measured_12v == rhs.measured_12v &&
    lhs.measured_5v == rhs.measured_5v &&
    lhs.drive_current == rhs.drive_current &&
