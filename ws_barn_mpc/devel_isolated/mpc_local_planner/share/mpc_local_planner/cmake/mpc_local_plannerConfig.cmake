...
if(NOT "/home/turan/3v3/ws_barn_mpc/devel_isolated/mpc_local_planner/include;/home/turan/3v3/ws_barn_mpc/src/mpc_local_planner/mpc_local_planner/include;/usr/include/eigen3 " STREQUAL " ")
  set(mpc_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/turan/3v3/ws_barn_mpc/devel_isolated/mpc_local_planner/include;/home/turan/3v3/ws_barn_mpc/src/mpc_local_planner/mpc_local_planner/include;/usr/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpc_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turan/3v3/ws_barn_mpc/src/mpc_local_planner/mpc_local_planner/${idir}'.  ${_report}")
    endif()
